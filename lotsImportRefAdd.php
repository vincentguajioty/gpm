...
else
{
	...
	writeInLogs("Import du référentiel dans le lot " . $_GET['id'] . " avec ". $ok ." imports réussi, ". $doublons ." imports annulés car doublons, ". $nok ." imports annulés car erreur inconnue.", '2');
