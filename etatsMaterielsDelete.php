...
else
{
    ...
    {
        case '00000':
            writeInLogs("Suppression de l'état de lot " . $data['libelleMaterielsEtat'], '4');
            $_SESSION['returnMessage'] = 'Etat de lot supprimé avec succès.';
            $_SESSION['returnType'] = '1';
            break;

        default:
            writeInLogs("Erreur inconnue lors de la suppression de l'état de lot " . $data['libelleMaterielsEtat'], '5');
