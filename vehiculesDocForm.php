...
if($_SESSION['vehicules_modification']==1)
{?>
    <div class="modal fade" id="modalVehiculesDocAdd">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Attacher un document au véhicule</h4>
                </div>
                <form role="form" action="vehiculesDocAdd.php?idVehicule=<?=$_GET['idVehicule']?>" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Document à charger: <small style="color:grey;">Requis</small></label>
                            <input style="width: 100%;" type="file" name="urlFichierDocVehicule" id="urlFichierDocVehicule" required>
                        </div>
                        <div class="form-group">
                            <label>Nom du document: <small style="color:grey;">Requis</small></label>
                            <input type="text" class="form-control" name="nomDocVehicule" required>
                        </div>
                        <div class="form-group">
