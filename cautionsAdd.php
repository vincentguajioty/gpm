...
else
{
    ...
    $query = $db->prepare('INSERT INTO CAUTIONS SET idPersonne = :idPersonne, personneNonGPM = :personneNonGPM, montantCaution = :montantCaution, dateEmissionCaution = :dateEmissionCaution, dateExpirationCaution = :dateExpirationCaution, detailsMoyenPaiement = :detailsMoyenPaiement;');
    $query->execute(array(
    ...
    {
        case '00000':
            writeInLogs("Ajout d'une caution.", '2');
            $_SESSION['returnMessage'] = 'Caution ajoutée avec succès.';
            $_SESSION['returnType'] = '1';
            break;

        default:
            writeInLogs("Erreur inconnue lors de l'ajout de d'une caution.", '5');
