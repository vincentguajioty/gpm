...
else
{
    ...
    $query = $db->prepare('UPDATE TENUES_AFFECTATION SET idCatalogueTenue = :idCatalogueTenue, idPersonne = :idPersonne, personneNonGPM = :personneNonGPM, dateAffectation = :dateAffectation, dateRetour = :dateRetour WHERE idTenue = :idTenue;');
    $query->execute(array(
    ...
    {
        case '00000':
            writeInLogs("Modification d'une affectation de tenue.", '3');
        ...
        default:
            writeInLogs("Erreur inconnue lors de la modification de l'affectation.", '5');
