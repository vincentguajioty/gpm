...
else
{
    ...
    $query = $db->prepare('UPDATE VHF_CANAL SET rxFreq = :rxFreq, txFreq = :txFreq, rxCtcss = :rxCtcss, txCtcss = :txCtcss, niveauCtcss = :niveauCtcss, txPower = :txPower, chName = :chName, appelSelectifCode = :appelSelectifCode, appelSelectifPorteuse = :appelSelectifPorteuse, let = :let, notone = :notone, idVhfTechno = :idVhfTechno, remarquesCanal = :remarquesCanal WHERE idVhfCanal = :idVhfCanal;');
    $query->execute(array(
        'rxFreq' => $_POST['rxFreq'],
        'txFreq' => $_POST['txFreq'],
    ...
    {
        case '00000':
            writeInLogs("Ajout du canal " . $_POST['chName'], '3');
            $_SESSION['returnMessage'] = 'Canal modifié avec succès.';
            $_SESSION['returnType'] = '1';
            break;

        default:
            writeInLogs("Erreur inconnue lors de la modification du canal " . $_POST['chName'], '5');
