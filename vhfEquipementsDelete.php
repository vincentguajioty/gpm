...
else
{
    ...
    {
        case '00000':
            writeInLogs("Suppression de l'équipement radio " . $data['vhfIndicatif'], '4');
        ...
        default:
            writeInLogs("Erreur inconnue lors de la suppression de l'équipement radio " . $data['vhfIndicatif'], '5');
