...
ALTER TABLE PROFILS ADD consommationLots_lecture BOOLEAN;
ALTER TABLE PROFILS ADD consommationLots_affectation BOOLEAN;
ALTER TABLE PROFILS ADD consommationLots_supression BOOLEAN;

UPDATE PROFILS SET
	consommationLots_lecture     = 0,
	consommationLots_affectation = 0,
	consommationLots_supression  = 0;
