...
switch($data['version'])
{
    ...
    case '14.0':
        writeInLogs("Début de l'installation de la mise à jour 14.1", '1', NULL);
        $query = $db->query(file_get_contents ("update14.1.sql"));
        writeInLogs("Fin de l'installation de la mise à jour 14.1", '1', NULL);
        echo "<script type='text/javascript'>document.location.replace('INSTALL2.php');</script>";
        break;
