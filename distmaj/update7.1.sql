...
ALTER TABLE PROFILS ADD cautions_suppression BOOLEAN;

UPDATE PROFILS SET
	cautions_lecture = 0,
	cautions_ajout = 0,
	cautions_modification = 0,
	cautions_suppression = 0;
...
CREATE TABLE CAUTIONS(
	idCaution INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
	idPersonne INT,
	personneNonGPM VARCHAR(100),
	montantCaution FLOAT,
	dateEmissionCaution DATE,
	dateExpirationCaution DATE,
	detailsMoyenPaiement TEXT,
	CONSTRAINT fk_cautions_personnes
		FOREIGN KEY (idPersonne)
		REFERENCES PERSONNE_REFERENTE(idPersonne));
		
CREATE TABLE PERSONNE_REFERENTE_TEMP(
