...
const LotsTable = ({
    ...
    displayLibelleLotsEtat = true,
    displayLibelleTypeLot = true,
    displayIdentifiant = true,
    displayMateriels = true,
    displayProchainInventaire = true,
    displayNbAlertesEnCours = true,
    displayNotifiationEnabled = true,
    displayActions = true,
    ...
    const initPage = async () => {
        try {
            ...
            {
                setLotsArray(getConfig.data.filter(lot => lot.idPersonne == HabilitationService.habilitations.idPersonne));
            }else{
    ...
    const colonnes = [
        ...
        },
        {
            ...
            isHidden: !displayLibelleLotsEtat,
            Header: 'Etat',
        },
        {
            accessor: 'libelleTypeLot',
            isHidden: !displayLibelleTypeLot,
            Header: 'Référentiel',
            Cell: ({ value, row }) => {
        ...
        },
        {
            ...
            isHidden: !displayProchainInventaire,
        ...
        },
        {
            ...
            isHidden: !displayNotifiationEnabled,
    ...
    const requestExport = async () => {
        try {
            ...
            let fileRequest = await Axios.get('/lots/exporterLotsEtendus');
                        ...
                        topButton={
                            ...
                            :
                                <>
                                    ...
                                    {HabilitationService.habilitations['lots_lecture'] && HabilitationService.habilitations['sac_lecture'] && HabilitationService.habilitations['materiel_lecture'] ?
                                        <IconButton
                                            icon='download'
                                            size = 'sm'
