...
const AuthPwdForgotten = ({ leftSideContent, children, footer = true }) => {
    return (
                                    ...
                                    <div className="position-relative p-4 pt-md-5 pb-md-7">
                                        ...
                                        <div className="z-index-1 position-relative light">
                                            ...
                                            <p className="opacity-75 text-white">
                                                Mot de passe oublié, procédure de réinitialisation du mot de passe en autonomie
                                            </p>
                                        </div>
                                    </div>
...
AuthPwdForgotten.propTypes = {
    leftSideContent: PropTypes.node,
    children: PropTypes.node.isRequired,
    footer: PropTypes.bool
};

export default AuthPwdForgotten;
