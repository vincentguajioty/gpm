        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Imprimer le code barre du conteneur</h4>
                </div>
                <form role="form" class="spinnerAttenteSubmit" action="reserveConteneurCBShow.php?id=<?=$_GET['id']?>" method="POST">
