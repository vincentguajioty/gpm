        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Imprimer tous les codes barre d'emplacement liés à un sac</h4>
                </div>
                <form role="form" class="spinnerAttenteSubmit" action="sacsCBShow.php?id=<?=$_GET['id']?>" method="POST">
