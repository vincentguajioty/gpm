        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Imprimer des codes barre de matériel</h4>
                </div>
                <form role="form" class="spinnerAttenteSubmit" action="codesBarreShow.php?id=<?=$_GET['id']?>" method="POST">
