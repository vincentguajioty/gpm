ALTER TABLE LOTS_LOTS ADD inventaireEnCours BOOLEAN;
ALTER TABLE RESERVES_CONTENEUR ADD inventaireEnCours BOOLEAN;

CREATE TABLE CODES_BARRE(
	idCode INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
	codeBarre VARCHAR(100),
	internalReference BOOLEAN,
	peremptionConsommable DATE,
	commentairesCode TEXT,
	idMaterielCatalogue INT,
	CONSTRAINT fk_cb_catalogue
		FOREIGN KEY (idMaterielCatalogue)
		REFERENCES MATERIEL_CATALOGUE(idMaterielCatalogue)
);

ALTER TABLE CODES_BARRE ADD UNIQUE(codeBarre);

ALTER TABLE PROFILS ADD codeBarre_lecture BOOLEAN;
ALTER TABLE PROFILS ADD codeBarre_ajout BOOLEAN;
ALTER TABLE PROFILS ADD codeBarre_modification BOOLEAN;
ALTER TABLE PROFILS ADD codeBarre_suppression BOOLEAN;

UPDATE PROFILS SET
	codeBarre_lecture = 0,
	codeBarre_ajout = 0,
	codeBarre_modification = 0,
	codeBarre_suppression = 0;
...
UPDATE CONFIG set version = '12.0';