    ...
    try {
        let result = await db.query(`
            SELECT
                ...
                pr.notif_benevoles_vhf,
                pr.notif_benevoles_tenues,
...
exports.updateMonCompte = async (req, res, next)=>{
    try {
        ...
        ;`,{
            ...
            notif_benevoles_vhf: req.body.data.notif_benevoles_vhf ? true : false,
            notif_benevoles_tenues: req.body.data.notif_benevoles_tenues ? true : false,
    ...
    try {
        const utilisateur = await db.query(`
            ...
            SET
                ...
                notif_benevoles_vhf           = false,
                notif_benevoles_tenues        = false,
