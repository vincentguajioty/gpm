...
router.get('/select/getPneumatiques',                          loggerMiddleware.httpLogger(), jwtFunctions.verifyJWTandProfile(['connexion_connexion']),      selectForListsCtrl.getPneumatiques);
...
//OPERATIONNEL - Sacs
router.post('/sacs/getSacs',               loggerMiddleware.httpLogger(), jwtFunctions.verifyJWTandProfile(['sac_lecture']),                                             sacsCtrl.getSacs);
...
router.post('/centresCouts/centreCoutsDelete',              loggerMiddleware.httpLogger(), jwtFunctions.verifyJWTandProfile(['cout_supprimer']),    loggerMiddleware.suppressionLogger(),  centresCoutsCtrl.centreCoutsDelete);
...
router.get('/settingsMetiers/getPneumatiques',                              loggerMiddleware.httpLogger(), jwtFunctions.verifyJWTandProfile(['carburants_lecture']),                                                     settingsMetiersCtrl.getPneumatiques);
router.post('/settingsMetiers/addPneumatiques',                             loggerMiddleware.httpLogger(), jwtFunctions.verifyJWTandProfile(['carburants_ajout']),                loggerMiddleware.modificationLogger(), settingsMetiersCtrl.addPneumatiques);
router.post('/settingsMetiers/updatePneumatiques',                          loggerMiddleware.httpLogger(), jwtFunctions.verifyJWTandProfile(['carburants_modification']),         loggerMiddleware.modificationLogger(), settingsMetiersCtrl.updatePneumatiques);
router.post('/settingsMetiers/deletePneumatiques',                          loggerMiddleware.httpLogger(), jwtFunctions.verifyJWTandProfile(['carburants_suppression']),          loggerMiddleware.suppressionLogger(),  settingsMetiersCtrl.deletePneumatiques);
...
router.get('/settingsMetiers/getCatalogueEnrichi',                          loggerMiddleware.httpLogger(), jwtFunctions.verifyJWTandProfile(['catalogue_lecture']),                                                      settingsMetiersCtrl.getCatalogueEnrichi);
router.get('/settingsMetiers/getCatalogueMaterielOpe',                      loggerMiddleware.httpLogger(), jwtFunctions.verifyJWTandProfile(['catalogue_lecture']),                                                      settingsMetiersCtrl.getCatalogueMaterielOpe);
router.get('/settingsMetiers/getCatalogueMaterielVehicules',                loggerMiddleware.httpLogger(), jwtFunctions.verifyJWTandProfile(['catalogue_lecture']),                                                      settingsMetiersCtrl.getCatalogueMaterielVehicules);
router.get('/settingsMetiers/getCatalogueMaterielTenues',                   loggerMiddleware.httpLogger(), jwtFunctions.verifyJWTandProfile(['catalogue_lecture']),                                                      settingsMetiersCtrl.getCatalogueMaterielTenues);
router.get('/settingsMetiers/getCatalogueMaterielVHF',                      loggerMiddleware.httpLogger(), jwtFunctions.verifyJWTandProfile(['catalogue_lecture']),                                                      settingsMetiersCtrl.getCatalogueMaterielVHF);
...
router.post('/settingsMetiers/mergeCatalogueItems',                         loggerMiddleware.httpLogger(), jwtFunctions.verifyJWTandProfile(['catalogue_modification']),          loggerMiddleware.modificationLogger(), settingsMetiersCtrl.mergeCatalogueItems);
...
router.get('/settingsMetiers/genererExportCatalogueMateriel',               loggerMiddleware.httpLogger(), jwtFunctions.verifyJWTandProfile(['catalogue_lecture']),               loggerMiddleware.suppressionLogger(),  settingsMetiersCtrl.genererExportCatalogueMateriel);
