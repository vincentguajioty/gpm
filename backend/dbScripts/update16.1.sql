...
ALTER TABLE TENUES_AFFECTATION ADD demandeBenevoleRemplacement BOOLEAN DEFAULT FALSE;
ALTER TABLE TENUES_AFFECTATION ADD demandeBenevoleRemplacementMotif TEXT DEFAULT NULL;
ALTER TABLE TENUES_AFFECTATION ADD demandeBenevolePret BOOLEAN DEFAULT FALSE;
ALTER TABLE TENUES_AFFECTATION ADD demandeBenevolePretMotif TEXT DEFAULT NULL;
...
ALTER TABLE PERSONNE_REFERENTE ADD notif_benevoles_tenues BOOLEAN AFTER notif_benevoles_vhf;
UPDATE PERSONNE_REFERENTE SET notif_benevoles_tenues = 0;
