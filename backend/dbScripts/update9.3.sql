ALTER TABLE MATERIEL_CATALOGUE ADD idFournisseur INT;
ALTER TABLE MATERIEL_CATALOGUE ADD CONSTRAINT fk_catalogue_fournisseur FOREIGN KEY(idFournisseur) REFERENCES FOURNISSEURS(idFournisseur);
