...
CREATE TABLE VEHICULES_PNEUMATIQUES(
	idPneumatique INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
    libellePneumatique VARCHAR(150)
);

INSERT INTO VEHICULES_PNEUMATIQUES SET idPneumatique = 1, libellePneumatique="Pneu été";
INSERT INTO VEHICULES_PNEUMATIQUES SET idPneumatique = 2, libellePneumatique="Pneu hivers";
INSERT INTO VEHICULES_PNEUMATIQUES SET idPneumatique = 3, libellePneumatique="Pneu 4 saisons";

ALTER TABLE VEHICULES ADD idPneumatiqueAvant INT NULL;
ALTER TABLE VEHICULES ADD idPneumatiqueArriere INT NULL;
ALTER TABLE VEHICULES ADD CONSTRAINT fk_pneu_avant FOREIGN KEY(idPneumatiqueAvant) REFERENCES VEHICULES_PNEUMATIQUES(idPneumatique);
ALTER TABLE VEHICULES ADD CONSTRAINT fk_pneu_arriere FOREIGN KEY(idPneumatiqueArriere) REFERENCES VEHICULES_PNEUMATIQUES(idPneumatique);

ALTER TABLE VEHICULES ADD dimensionPneuAvant VARCHAR(15) NULL;
ALTER TABLE VEHICULES ADD dimensionPneuArriere VARCHAR(15) NULL;

ALTER TABLE VEHICULES ADD pressionPneuAvant FLOAT NULL;
ALTER TABLE VEHICULES ADD pressionPneuArriere FLOAT NULL;

UPDATE VEHICULES SET idPneumatiqueAvant = 1, idPneumatiqueArriere = 1;

UPDATE VEHICULES SET idPneumatiqueAvant = 2 WHERE pneusAVhivers = 1;
UPDATE VEHICULES SET idPneumatiqueArriere = 2 WHERE pneusARhivers = 1;

ALTER TABLE VEHICULES DROP pneusAVhivers;
ALTER TABLE VEHICULES DROP pneusARhivers;
