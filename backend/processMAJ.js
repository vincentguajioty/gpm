...
const majDB = async () => {
    try {
        ...
        switch(configDB[0].version)
        {
            ...
            case '16.0':
                logger.info('Version 16.0 détectée - Upgrade à la version suivante')
                update = await runDBScript('./dbScripts/update16.1.sql');
                logger.debug(update);
                finalResult = finalResult && await majDB();
                logger.debug(finalResult);
            break;
            ...
            case '16.1':
                logger.info('Version 16.1 détectée - Upgrade à la version suivante')
                update = await runDBScript('./dbScripts/update16.2.sql');
                logger.debug(update);
                finalResult = finalResult && await majDB();
                logger.debug(finalResult);
            break;
            ...
            case '16.2':
                logger.info('Version 16.2 détectée - Upgrade à la version suivante')
                update = await runDBScript('./dbScripts/update16.3.sql');
                logger.debug(update);
                finalResult = finalResult && await majDB();
                logger.debug(finalResult);
            break;
            ...
            case '16.3':
                logger.info('Version 16.3 détectée - Upgrade à la version suivante')
                update = await runDBScript('./dbScripts/update16.4.sql');
                logger.debug(update);
                finalResult = finalResult && await majDB();
                logger.debug(finalResult);
            break;
            ...
            case '16.4':
                logger.info('Version 16.4 détectée - Upgrade à la version suivante')
                update = await runDBScript('./dbScripts/update16.5.sql');
                logger.debug(update);
                finalResult = finalResult && await majDB();
                logger.debug(finalResult);
            break;
