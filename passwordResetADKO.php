...
<div class="login-box">
    ...
    { ?>
        <div class="alert alert-warning">
            <center>
                <h4>Réinitialisation impossible</h4>
                Votre compte est lié à un ActiveDirectory, la gestion du mot de passe ne se fait donc pas dans <?=$APPNAME?>. Veuillez prendre contact avec votre admistrateur.
            </center>
        </div>
    <?php }
    else
