...
<?php
    ...
    $query = $db->prepare('UPDATE PERSONNE_REFERENTE SET nomPersonne = :nomPersonne, prenomPersonne = :prenomPersonne, mailPersonne = :mailPersonne, telPersonne = :telPersonne, fonction = :fonction WHERE idPersonne = :idPersonne ;');
    $query->execute(array(
