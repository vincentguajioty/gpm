...
$query = $db->prepare('SELECT COUNT(*) as nb FROM VEHICULES_ALERTES WHERE ipDeclarant = :ipDeclarant AND dateCreationAlerte > :dateCreationAlerte AND idVehiculesAlertesEtat = 1;');
$query->execute(array(
...
<div class="modal fade modal-danger" id="modalAlerteSuppress">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" action="vehiculesAlerteBenevoleLockIpLock.php?id=<?=$_GET['id']?>" method="POST">
