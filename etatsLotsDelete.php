...
else
{
    ...
    {
        case '00000':
            writeInLogs("Suppression de l'état de lot " . $data['libelleLotsEtat'], '1', NULL);
            $_SESSION['returnMessage'] = 'Etat de lot supprimé avec succès.';
            $_SESSION['returnType'] = '1';
            break;

        default:
            writeInLogs("Erreur inconnue lors de la suppression de l'état de lot " . $data['libelleLotsEtat'], '3', NULL);
