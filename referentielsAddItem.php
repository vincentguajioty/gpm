...
else
{
    ...
    {
        case '00000':
            writeInLogs("Modification du référentiel " . $data2['libelleTypeLot'] . " avec ajout du materiel " . $_POST['libelleMateriel'], '1', NULL);
            $_SESSION['returnMessage'] = 'Item ajouté avec succès au référentiel.';
            $_SESSION['returnType'] = '1';
            break;

        case '23000':
            writeInLogs("Doublon déteté lors de la modification du référentiel " . $data2['libelleTypeLot'] . " avec ajout du materiel " . $_POST['libelleMateriel'], '2', NULL);
        ...
        default:
            writeInLogs("Erreur inconnue lors de la modification du référentiel " . $data2['libelleTypeLot'] . " avec ajout du materiel " . $_POST['libelleMateriel'], '3', NULL);
