...
else
{
    ...
    {
        case '00000':
            writeInLogs("Modification de la catégorie " . $_POST['libelleCategorie'], '1', NULL);
            $_SESSION['returnMessage'] = 'Catégorie modifiée avec succès.';
            $_SESSION['returnType'] = '1';
            break;

        case '23000':
            writeInLogs("Doublon détecté lors de la modification de la catégorie " . $_POST['libelleCategorie'], '2', NULL);
            $_SESSION['returnMessage'] = 'Une catégorie existe déjà avec le même libellé. Merci de changer le libellé.';
            $_SESSION['returnType'] = '2';
            break;

        default:
            writeInLogs("Erreur inconnue lors de la modification de la catégorie " . $_POST['libelleCategorie'], '3', NULL);
