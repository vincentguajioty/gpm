            ...
            <div class="box">
                ...
                <div class="box-body">
                    <table id="tri2R" class="table table-bordered table-hover">
                        ...
                        <tbody>
                        <?php
                        $query = $db->prepare('SELECT c.idCommande, c.nomCommande, c.dateCreation, f.nomFournisseur, e.libelleEtat, c.idEtat FROM COMMANDES c LEFT OUTER JOIN COMMANDES_ETATS e ON c.idEtat = e.idEtat LEFT OUTER JOIN FOURNISSEURS f ON c.idFournisseur = f.idFournisseur WHERE c.idEtat = 2;');
                        $query->execute(array(
