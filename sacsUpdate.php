...
else
{
    ...
    {
        case '00000':
            writeInLogs("Modification du sac " . $_POST['libelleSac'], '1', NULL);
            $_SESSION['returnMessage'] = 'Sac modifié avec succès.';
            $_SESSION['returnType'] = '1';
            break;

        case '23000':
            writeInLogs("Doublon détecté lors de la modification du sac " . $_POST['libelleSac'], '2', NULL);
        ...
        default:
            writeInLogs("Erreur inconnue lors de la modification du sac " . $_POST['libelleSac'], '3', NULL);
