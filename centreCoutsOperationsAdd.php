...
else
{
    ...
    {
        case '00000':
            writeInLogs("Ajout d'une opération dans le centre de couts " . $_GET['idCentreDeCout'], '2');
            $_SESSION['returnMessage'] = 'Opération ajoutée avec succès.';
            $_SESSION['returnType'] = '1';
            break;

        default:
            writeInLogs("Erreur inconnue lors de l'ajout d'une opération dans le centre de couts " . $_GET['idCentreDeCout'], '5');
