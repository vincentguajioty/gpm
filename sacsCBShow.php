...
<body onload="window.print();">
    <div style="margin-left: 5%">
        ...
        $codes = $db->prepare('SELECT e.*, s.libelleSac, l.libelleLot FROM MATERIEL_EMPLACEMENT e LEFT OUTER JOIN MATERIEL_SAC s ON e.idSac = s.idSac LEFT OUTER JOIN LOTS_LOTS l ON s.idLot = l.idLot WHERE e.idSac = :idSac');
        $codes->execute(array('idSac'=>$_GET['id']));
