...
else
{
    ...
    {
        case '00000':
            writeInLogs("Suppression de l'état de véhicule " . $data['libelleVehiculesEtat'], '4');
            $_SESSION['returnMessage'] = 'Etat de véhicule supprimé avec succès.';
            $_SESSION['returnType'] = '1';
            break;

        default:
            writeInLogs("Erreur inconnue lors de la suppression de l'état de véhicule " . $data['libelleVehiculesEtat'], '5');
