...
else
{
    ...
    {
        case '00000':
            writeInLogs("Suppression de l'inventaire du conteneur de réserve " . $data['libelleConteneur'] . " réalisé en date du " . $data['dateInventaire'], '4');
            $_SESSION['returnMessage'] = 'Inventaire supprimé avec succès.';
            $_SESSION['returnType'] = '1';
            break;

        default:
            writeInLogs("Erreur inconnue lors de la suppression de l'inventaire du lot " . $data['libelleConteneur'] . " réalisé en date du " . $data['dateInventaire'], '5');
