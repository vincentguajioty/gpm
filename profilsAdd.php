...
else
{
    ...
    $_POST['alertesBenevolesLots_lecture']              = ($_POST['alertesBenevolesLots_lecture']              == 1) ? 1 : 0;
    $_POST['alertesBenevolesLots_affectation']          = ($_POST['alertesBenevolesLots_affectation']          == 1) ? 1 : 0;
    $_POST['alertesBenevolesLots_affectationTier']      = ($_POST['alertesBenevolesLots_affectationTier']      == 1) ? 1 : 0;
    ...
    $query->execute(array(
        ...
        'alertesBenevolesLots_lecture'              => $_POST['alertesBenevolesLots_lecture'],
        'alertesBenevolesLots_affectation'          => $_POST['alertesBenevolesLots_affectation'],
        'alertesBenevolesLots_affectationTier'      => $_POST['alertesBenevolesLots_affectationTier'],
    ...
    {
        case '00000':
            writeInLogs("Ajout du profil " . $_POST['libelleProfil'], '1', NULL);
            $_SESSION['returnMessage'] = 'Profil ajouté avec succès.';
            $_SESSION['returnType'] = '1';
            break;

        case '23000':
            writeInLogs("Doublon détecté lors de l'ajout du profil " . $_POST['libelleProfil'], '2', NULL);
            $_SESSION['returnMessage'] = "Un profil existe déjà avec le même libellé. Merci de changer le libellé";
            $_SESSION['returnType'] = '2';
            break;

        default:
            writeInLogs("Erreur inconnue lors de l'ajout du profil " . $_POST['libelleProfil'], '3', NULL);
